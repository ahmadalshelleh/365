...
@section('content')
    <div class="main-div-content">
        <div class="row">
            <div class="col-md-6 main-div-content-left">Drugs</div>
            <div class="col-md-6 main-div-content-right"><a href="/admin/dashboard">Dashboard</a> / drugs</div>
        </div>
    </div>
    <br />
                ...
                <table class="table table-bordered table-hover pages-table">
                    ...
                    @foreach($drugs as $drug)
                        <tr>
                            <td>{{$drug->id}}</td>
                            <td>{{$drug->name}}</td>
                            <td><a href="/admin/drug/edit/{{$drug->id}}">Edit</a></td>
                            <td><a href="#" onclick="deleteDrug({{$drug->id}})">Delete</a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
