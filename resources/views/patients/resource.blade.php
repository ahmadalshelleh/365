                            ...
                            <div class="container">
                                <div class="row appointments-div">
                                    ...
                                    <div class="col-4 text-center appointments-headers">
                                        <a href="/patient/resources" class="appointments-headers-text">الملفات</a>
                                    </div>
                                </div>
                            </div>
                        </div><br />
                            ...
                            <div class="appointment-table-container">
                                <div class="container">
                                    <div class="table-responsive">
                                        <table id="patient_resource_table" class="table table-hover table-center mb-0 datatable-style">
                                            <thead>
                                            <tr>
                                                <th>رقم الملف</th>
                                                <th>التاريخ </th>
