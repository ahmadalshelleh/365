...
@section('content')
    ...
    <div class="row line-header-section">
        <div class="col-12">
            <div class="row">
                <a href="/patients/dashboard">الرئيسية</a> /الأدوية
            </div>
                        ...
                        <div class="row">
                            <nav class="nav-drugs">
                                <ul class="pagination pg1 simple-pagination">
                                    ...
                                    <li class="page-link"><span class="ellipse clickable">…</span></li>
                                    <li><a href="#page-122" class="page-link">122</a></li>
                                    <li><a href="#page-123" class="page-link">123</a></li>
